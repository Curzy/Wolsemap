...
def insert_price(station_id):
    ...
    if crawled :
        ...
        print(str(station_id) + ' ' + str(price_object.station.name) + ' ' + str(price_object.deposit) + '/' + str(price_object.price))
        return price_object.station.name, price_object.deposit, price_object.price
